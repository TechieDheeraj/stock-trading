...
/*
  ...
  writer.Key("orderId");
  writer.String(this->orderId.c_str());
  writer.Key("symbol");
  writer.String(this->symbol.c_str());
  writer.Key("assetId");
  writer.String(this->assetId.c_str());
  writer.Key("exchange");
  writer.String(this->exchange.c_str());
  writer.Key("assetType");
  writer.String(this->assetType.c_str());
  writer.Key("accountId");
  writer.String(this->accountId.c_str());
  writer.Key("portfolioId");
  writer.String(this->portfolioId.c_str());
  writer.Key("side");
  writer.String(this->side.c_str());
  writer.Key("orderType");
  writer.String(this->orderType.c_str());
  writer.Key("quantity");
  writer.Double(this->quantity);
  writer.Key("price");
  writer.Double(this->price);
  writer.Key("auxPrice");
  writer.Double(this->auxPrice);
  writer.Key("timeInForce");
  writer.String(this->timeInForce.c_str());
  writer.Key("stopPrice");
  writer.Double(this->stopPrice);
  writer.Key("routing");
  writer.String(this->routing.c_str());
  writer.Key("parentOrderId");
  writer.String(this->parentOrderId.c_str());
  writer.Key("bulkOrderId");
  writer.String(this->bulkOrderId.c_str());
  writer.Key("status");
  writer.Uint(this->status);
  writer.Key("altOrderId");
  writer.String(this->altOrderId.c_str());
  writer.Key("rebalanceId");
  writer.String(this->rebalanceId.c_str());
  writer.Key("modelId");
  writer.String(this->modelId.c_str());
  writer.Key("orderTime");
  writer.String(this->orderTime.c_str());
  writer.Key("updateDate");
  writer.String(this->updateDate.c_str());
...
int main()
{
  ...
  order.parentOrderId = "parent order id";
  order.bulkOrderId = "bulk order id";
  order.status = 1;
  order.altOrderId = "alt order id";
  order.rebalanceId = "rebalance id";
  order.modelId = "model id";
  order.orderTime = "order time";
  order.updateDate = "update date";

  std::cout << order.serialise() << std::endl;
